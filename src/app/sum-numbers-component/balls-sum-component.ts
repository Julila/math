...
@Component({
  ...
  templateUrl: './balls-sum-component.html',
  styleUrl: './balls-sum-component.css',
})
export class BallSumComponent implements OnInit {
  ...
  generateNewGame() {
    ...
    this.leftGridNumber = Math.floor(Math.random() * 10) + 1;
